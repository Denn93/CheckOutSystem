...
namespace ProductClient.ProductServiceRef {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Product", Namespace="http://schemas.datacontract.org/2004/07/MyWCFService.DatabaseService")]
    ...
    public interface IProductService {
        ...
        ProductClient.ProductServiceRef.Product GetProduct(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProductService/GetProduct", ReplyAction="http://tempuri.org/IProductService/GetProductResponse")]
        System.Threading.Tasks.Task<ProductClient.ProductServiceRef.Product> GetProductAsync(int id);
        ...
        bool UpdateProduct(ProductClient.ProductServiceRef.Product product);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProductService/UpdateProduct", ReplyAction="http://tempuri.org/IProductService/UpdateProductResponse")]
        System.Threading.Tasks.Task<bool> UpdateProductAsync(ProductClient.ProductServiceRef.Product product);
    }
    ...
    public partial class ProductServiceClient : System.ServiceModel.ClientBase<ProductClient.ProductServiceRef.IProductService>, ProductClient.ProductServiceRef.IProductService {
        ...
        public ProductClient.ProductServiceRef.Product GetProduct(int id) {
            return base.Channel.GetProduct(id);
        }
        
        public System.Threading.Tasks.Task<ProductClient.ProductServiceRef.Product> GetProductAsync(int id) {
            return base.Channel.GetProductAsync(id);
        }
        
        public bool UpdateProduct(ProductClient.ProductServiceRef.Product product) {
            return base.Channel.UpdateProduct(product);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateProductAsync(ProductClient.ProductServiceRef.Product product) {
